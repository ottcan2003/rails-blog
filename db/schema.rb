...
ActiveRecord::Schema.define(version: 20161230201950) do
  ...
  create_table "c_omments", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_c_omments_on_post_id"
    t.index ["visitor_id"], name: "index_c_omments_on_visitor_id"
  end
